      ...
      <div class="row" style="height: 100%; margin: 20px;">
        ...
        <div class="col" style="background-color:#F5F5F5;font-size: large;padding: 0px;">
          <div class="group-top">
           ...
           <div class="timeList">
            <li>
              <button type="button" class="time">Default</button>
            </li>
            </div>
          </ul>
	...
	$.ajax({
		...
		success:function(data){
			...
			for(let list of data){
				$timeList = $(
						"<li>"+
              "<button type='button' class='time' >"+list.startDate+"~"+list.endDate+"</button>"+
            "</li>"		
					);
			...
			$DataToForm=$("<input type='hidden' name='placeId' value='"+placeId+"'>"+
					        		"<input type='hidden' name='movieId' value='"+movieId+"'>"+
					        		"<input type='hidden' name='startDate' value='"+startDate+"'>"+
					        		"<input type='hidden' name='endDate' value='"+endDate+"'>");
    		$("#time.link-list").append($DataToForm);
				});
